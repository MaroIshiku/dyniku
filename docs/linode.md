...
1. Create a personal access token with `domains` set, with read and write privileges, ideally that never expires. You can refer to [Linode's guide](https://www.linode.com/docs/products/tools/api/guides/manage-api-tokens/).
